...
import { UpdatePosOrderSchema } from "../../validators"
...
export async function GET(
  ...
  try {
    ...
    throw new MedusaError(MedusaError.Types.NOT_FOUND, `POS Order ${id} not found`)
  }
}
...
export async function POST(
  ...
  if (payment_status !== undefined || preparation_status !== undefined || assigned_to_id !== undefined) {
