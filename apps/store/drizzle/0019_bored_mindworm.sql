...
ALTER TABLE "tenants" ADD COLUMN "api_key" varchar(500);--> statement-breakpoint
ALTER TABLE "tenants" ADD COLUMN "api_key_last_used_at" timestamp with time zone;--> statement-breakpoint
